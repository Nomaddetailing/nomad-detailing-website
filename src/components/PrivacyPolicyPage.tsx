    ...
    <>
        ...
        <div className="max-w-4xl mx-auto space-y-10">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 text-muted-foreground space-y-1">
              ...
              <li>
                To trusted service providers (such as payment gateways) strictly for service-related purposes
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p className="text-muted-foreground">
              By submitting your personal data through our website or booking forms, you consent to Nomad
              Detailing collecting, using, and processing your data in accordance with this Privacy Policy and
              the PDPA 2010.
            </p>
          </section>
      ...
      <div className="max-w-4xl mx-auto px-6 pb-16">
        <button
          ...
          onClick={() => {
            const returnTo =
              (sessionStorage.getItem("nav:returnTo") as any) || "booking";
